<template>
  <div>
    ...
    <replyDialog title="查看回复" :Username="curUname" :replyContent="curRepText" :isAdmin="isAdmin" :displayWindow="displayReply" :showContent="replyContent">
    </replyDialog>
    <el-dialog
    ...
    >
      ...
      <template #footer>
            <span class="dialog-footer">
                <el-button @click="dialogVisible = false;formRef.value.resetFields()">取消</el-button>
...
const replyApplication = (notice) =>{
  post("/recruit/getReply",{username:notice.applicantUsername},(data) => {
    curRepText.value=data;
    curUname.value=notice.applicantUsername;
